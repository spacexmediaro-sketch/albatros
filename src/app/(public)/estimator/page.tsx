    ...
    <section className="px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="text-center">
          <h1 className="font-[family-name:var(--font-dm-serif)] text-4xl text-[#0A2540] sm:text-5xl">
            Estimator avarii auto cu AI
          </h1>
          ...
          <div
            ...
            className={`relative flex min-h-[180px] cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed transition-colors ${
              dragOver
                ...
                : "border-gray-300 bg-gray-50 hover:border-[#E63946]/50 hover:bg-gray-100"
            }`}
            onClick={() =>
        ...
        {result && (
          <div className="mt-12 space-y-8">
            ...
            <div className="flex justify-center">
              <Badge className="bg-[#0A2540] px-4 py-1.5 text-sm text-white">
            ...
            <div>
              ...
              <Card className="border-2 border-[#0A2540]/10">
                <CardContent className="flex flex-col items-center py-6">
                  <p className="text-sm font-medium uppercase tracking-wider text-gray-500">
                    Interval estimat
                  </p>
                  <p className="mt-2 text-4xl font-bold text-[#0A2540]">
