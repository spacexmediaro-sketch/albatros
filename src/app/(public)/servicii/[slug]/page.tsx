...
const servicesData: Record<string, ServiceData> = {
  "diagnoza-auto": {
    ...
    paragraphs: [
      ...
      "Folosim echipamente de nivel dealer pentru mărcile cele mai populare: Volkswagen, Audi, BMW, Mercedes-Benz, Opel, Ford, Dacia, Renault, Skoda, Peugeot, Citroën și multe altele. Aceasta ne permite accesul la funcții avansate precum adaptări, codări și programări ale unităților de control.",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Putem diagnostica toate mărcile auto, atât europene cât și asiatice. Avem echipamente dedicate pentru grupul VAG (VW, Audi, Skoda, Seat), BMW, Mercedes, Opel, Ford, Dacia/Renault, Peugeot/Citroën, Toyota, Hyundai/Kia.",
      },
      {
  ...
  "reparatii-motoare-diesel": {
    ...
    cazuriTipice: [
      ...
      },
      {
        ...
        description:
          "Verificare bujii incandescente, pompa de alimentare, presiune rampa common-rail și sistem de preîncălzire.",
      },
      {
    ...
    cazuriTipice: [
      {
        ...
        description:
          "Injector defect care nu mai pulverizează corect, cauzând ratei și vibrații. Testare și înlocuire injector afectat.",
      },
      {
    ...
    faq: [
      {
        ...
        a: "În majoritatea cazurilor, reparația este avantajoasă economic — costă 40-60% din prețul unui injector nou. Un injector reparat profesional oferă performanțe comparabile cu unul nou. Recomandăm înlocuirea doar când injector corpul este deteriorat fizic.",
      },
      {
  ...
  "rectificari-chiulase": {
    ...
    paragraphs: [
      ...
      "După rectificare, chiulasa este asamblată cu supape noi sau reconditonate, arcuri verificate, simerirguri noi și este testată la presiune pentru a confirma etanșeitatea. Montajul final pe motor se realizează cu garnitură nouă și șuruburi de chiulasă noi (acolo unde este recomandat de producător).",
    ],
    cazuriTipice: [
      {
    ...
    faq: [
      {
        ...
        a: "Recomandăm verificarea de 2 ori pe an (la schimbul sezonier de anvelope) sau ori de câte ori observi simptome precum uzură neuniformă sau tragere laterală.",
      },
      {
        q: "Se face geometria pe toate mărcile?",
        a: "Da, echipamentul nostru 3D are în bază de date specificațiile pentru toate mărcile și modelele auto curente, inclusiv SUV-uri și utilitare.",
      },
      {
  ...
  "mecanica-auto": {
    ...
    paragraphs: [
      ...
      "Intervenim pe sistemul de suspensie și direcție: înlocuire amortizoare, arcuri, bucșe, bielete, capete de bară, pivote, rulmenți roată, fuzete. O suspensie în bună stare asigură confort, stabilitate și siguranță pe orice tip de drum.",
      "Alte lucrări de mecanică frecvente: înlocuire kit de distribuție (curea/lanț, role, pompă apă), schimb ambreiaj (placa, disc, rulment presiune, volantă), reparații cutie de viteze, înlocuire transmisie cardanică și planetare, reparații sistem de răcire (pompe, radiatoare, termostete).",
    ],
    cazuriTipice: [
      {
      ...
      },
      {
        ...
        description:
          "Înlocuire kit complet ambreiaj: disc, placa de presiune, rulment presiune. La motoarele cu volantă bimasa, verificare și eventual înlocuire.",
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Oferim ambele variante. Recomandăm piese OE sau aftermarket premium (Sachs, Lemförder, TRW, Brembo) care oferă calitate identică cu originalele la prețuri mai accesibile.",
      },
      {
  ...
  "incarcari-aer-conditionat": {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Da, este chiar recomandat! AC-ul dezumidifică aerul, prevenind aburirea geamurilor. De plus, utilizarea periodică menține componentele lubrifiate și previne deteriorarea garniturilor.",
      },
    ],
  },
};
...
export default async function ServiceDetailPage({
  ...
  return (
    <>
      ...
      {/* Breadcrumb */}
      <nav className="border-b bg-gray-50 px-4 py-3 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <ol className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li>/</li>
            <li>
              <Link href="/servicii" className="hover:text-[#0A2540]">
                Servicii
              </Link>
            </li>
            <li>/</li>
            <li className="font-medium text-[#0A2540]">{service.name}</li>
          </ol>
        </div>
      </nav>
      ...
      <section className="bg-[#0A2540] px-4 py-16 text-white sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <Badge className="mb-4 bg-[#E63946] text-white hover:bg-[#d32f3c]">
            {service.category}
          </Badge>
          <h1 className="font-[family-name:var(--font-dm-serif)] text-3xl leading-tight sm:text-4xl lg:text-5xl">
            {service.name}
          </h1>
      ...
      <section className="bg-gray-50 px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <h2 className="font-[family-name:var(--font-dm-serif)] text-2xl text-[#0A2540] sm:text-3xl">
            Cazuri tipice
          </h2>
            ...
            {service.cazuriTipice.map((caz, i) => (
              <Card key={i} className="h-full">
                <CardContent className="p-6">
                  ...
                  <p className="mt-2 text-sm text-gray-600">{caz.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      {/* CTA */}
      <section className="bg-[#0A2540] px-4 py-16 text-center text-white sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl">
          <h2 className="font-[family-name:var(--font-dm-serif)] text-2xl sm:text-3xl">
          ...
          <Link href="/programare">
            <Button
              size="lg"
              className="mt-8 bg-[#E63946] text-white hover:bg-[#d32f3c]"
            >
              Programează acum
            </Button>
          </Link>
