...
import { Phone, MapPin, Clock, Car, Wrench, Gauge, Zap, Droplets, Cog, CircuitBoard, Paintbrush, Shield, Users, Star } from "lucide-react";

export const metadata = generatePageMetadata({
  title: "Service Auto Băicoi — Albatros A Service | Blejoi, Prahova",
  description:
    "Service auto la 10 km de Băicoi, ~15 min pe drum. Reparații complete: mecanică, electrică, diesel, caroserie, geometrie 3D. Sună: 0723 177 032.",
  path: "/zone/service-auto-baicoi",
});
    ...
    <div className="min-h-screen bg-[#04040A]">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: `${siteConfig.url}/zone/service-auto-baicoi`,
            address: {
              "@type": "PostalAddress",
            ...
            areaServed: { "@type": "City", name: "Băicoi" },
      ...
      <nav className="relative z-10 mx-auto max-w-7xl px-4 pt-6 sm:px-6 lg:px-8">
        <ol className="flex items-center gap-2 text-sm text-[#8B8D97]">
          ...
          <li>/</li>
          <li className="text-[#E2E4E9]">Service Auto Băicoi</li>
        </ol>
      </nav>
      ...
      <section className="relative overflow-hidden px-4 pt-16 pb-24 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-7xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-[#8B8D97]">
            ...
            Albatros A Service este cel mai apropiat service complet pentru locuitorii din Băicoi —
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-6 space-y-4 text-[#E2E4E9]">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p>Lucrări minore (diagnoză, geometrie, AC) se finalizează în aceeași zi. Sună înainte pentru confirmare.</p>
                </div>
              </div>
            </div>
            <div className="overflow-hidden rounded-2xl border border-white/[0.08]">
              <iframe
                ...
                width="100%" height="350" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Albatros A Service - Harta Băicoi"
              />
            </div>
          </div>
        </div>
