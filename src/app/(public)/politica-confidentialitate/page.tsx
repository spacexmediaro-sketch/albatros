      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-8 text-gray-700 leading-relaxed">
          <div>
            ...
            <p>
              Operatorul de date cu caracter personal este <strong>ALBATROS A S.R.L.</strong>, cu
              ...
              <strong> albatrosa.ro</strong> sau când apelați la serviciile noastre de reparații auto.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Prezenta politică este elaborată în conformitate cu <strong>Regulamentul (UE)
          ...
          <div>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              <li>
                <strong>Date de identificare:</strong> nume, prenume, adresă de e-mail, număr de
                telefon — furnizate de dumneavoastră la completarea formularelor de contact sau
                programare.
              </li>
              <li>
                <strong>Date referitoare la vehicul:</strong> marca, modelul, anul de fabricație,
                numărul de înmatriculare, seria VIN — necesare pentru prestarea serviciilor de
                reparații auto.
              </li>
              <li>
                <strong>Date tehnice de navigare:</strong> adresa IP, tipul browserului, sistemul de
                operare, paginile vizitate, durata vizitei, sursa de referință — colectate automat
                prin cookie-uri și instrumente analitice.
              </li>
              <li>
                <strong>Imagini încărcate:</strong> fotografii ale avariilor auto, încărcate
                voluntar prin estimatorul AI — procesate exclusiv pentru furnizarea estimării.
              </li>
              <li>
                <strong>Date de comunicare:</strong> conținutul mesajelor transmise prin formularul
          ...
          <div>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              <li>
                <strong>Consimțământul dumneavoastră</strong> (art. 6 alin. 1 lit. a din GDPR) — pentru cookie-uri analitice, comunicări de marketing și încărcarea fotografiilor în estimator.
              </li>
              <li>
                <strong>Executarea unui contract</strong> (art. 6 alin. 1 lit. b din GDPR) — pentru procesarea programărilor și prestarea serviciilor de reparații auto.
              </li>
              <li>
                <strong>Interesul legitim</strong> (art. 6 alin. 1 lit. f din GDPR) — pentru asigurarea securității site-ului, prevenirea fraudei și îmbunătățirea serviciilor.
              </li>
              <li>
                <strong>Obligația legală</strong> (art. 6 alin. 1 lit. c din GDPR) — pentru respectarea cerințelor fiscale, contabile și legale aplicabile.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              <li><strong>Dreptul de acces</strong> — de a obține confirmarea prelucrării datelor și o copie a acestora.</li>
              <li><strong>Dreptul la rectificare</strong> — de a solicita corectarea datelor inexacte sau incomplete.</li>
              <li><strong>Dreptul la ștergere</strong> (&ldquo;dreptul de a fi uitat&rdquo;) — de a solicita eliminarea datelor, în condițiile prevăzute de lege.</li>
              <li><strong>Dreptul la restricționarea prelucrării</strong> — de a solicita limitarea prelucrării în anumite situații.</li>
              <li><strong>Dreptul la portabilitatea datelor</strong> — de a primi datele într-un format structurat, utilizat în mod curent și care poate fi citit automat.</li>
              <li><strong>Dreptul la opoziție</strong> — de a vă opune prelucrării datelor bazate pe interesul legitim.</li>
              <li><strong>Dreptul de a nu face obiectul unei decizii automate</strong> — de a nu fi supus unor decizii bazate exclusiv pe prelucrare automatizată.</li>
              <li><strong>Dreptul de a depune o plângere</strong> — la Autoritatea Națională de Supraveghere a Prelucrării Datelor cu Caracter Personal (ANSPDCP), cu sediul în București, B-dul G-ral Gheorghe Magheru 28-30, sector 1, www.dataprotection.ro.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              <a
                ...
                className="font-medium text-[#E63946] underline underline-offset-2 hover:text-[#d42d3a]"
              >
          ...
          <div>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              <li>
                <strong>Google Analytics</strong> — pentru analiza statistică a traficului web. Google procesează date în conformitate cu politica proprie de confidențialitate (policies.google.com/privacy).
              </li>
              <li>
                <strong>Furnizori de hosting și infrastructură</strong> — pentru stocarea și transmiterea datelor în condiții de siguranță.
              </li>
              <li>
                <strong>Autorități publice</strong> — atunci când există o obligație legală de comunicare.
              </li>
            </ul>
            <p className="mt-3">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-1 pl-2">
              ...
              <li>
                <strong>Adresă:</strong> Șoseaua Ploiești-Văleni FN, Blejoi, Prahova, 107070, România
              </li>
              <li>
                <strong>Telefon:</strong> 0723 177 032
              </li>
            </ul>
            <p className="mt-3">
