        ...
        <form action={formAction} className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input id="car" name="car" placeholder="ex: VW Golf 7 2.0 TDI" required />
            </div>
            <div className="space-y-2">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <select id="time" name="time" className="w-full rounded-md border px-3 py-2 text-sm">
          ...
          <div className="space-y-2">
            ...
            <Textarea id="notes" name="notes" placeholder="Descrie problema sau ce doresti..." rows={4} />
          </div>
